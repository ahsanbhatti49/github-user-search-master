package com.test.ahsan.app.model.dao;
...
public class GithubUserModel implements Parcelable {
    ...
    public final static Parcelable.Creator<GithubUserModel> CREATOR = new Creator<GithubUserModel>() {


        @SuppressWarnings({
                "unchecked"
        })
        public GithubUserModel createFromParcel(Parcel in) {
            return new GithubUserModel(in);
        }
    ...
    protected GithubUserModel(Parcel in) {
        ...
        this.email = ((String) in.readValue((Object.class.getClassLoader())));
